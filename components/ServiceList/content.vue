<template>
        <div class="service_content content_box container">
            <div class="container">
                <MainTitle chineseTitle="服務項目" enTitle="OUR SERVICE"/>
                <Breadcrumbs listName="服務項目"/>
            </div>
            <div class="service_box">
                <ul class="list_box">
                    <li class="list" v-for="item of serviceListData.ListBox">
                        {{ item.list }}
                    </li>
                </ul>
            </div>
